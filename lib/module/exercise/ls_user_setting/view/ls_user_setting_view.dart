          ...
          child: Column(
            children: [
              ...
              */
              ...
              SwitchListTile(
                value: mainStorage.get("exp_mode") ?? false,
                title: const Text("Experimental mode"),
                onChanged: (value) {
                  var current = mainStorage.get("exp_mode") ?? false;
                  mainStorage.put("exp_mode", !current);
                  controller.setState(() {});
                },
              ),
              SwitchListTile(
                value: mainStorage.get("off_mode") ?? false,
                title: const Text("Offline mode"),
                onChanged: (value) {
                  var current = mainStorage.get("off_mode") ?? false;
                  mainStorage.put("off_mode", !current);
                  controller.setState(() {});
                },
              ),
              SwitchListTile(
